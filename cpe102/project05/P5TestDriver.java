/**
 * Program 5 Test Driver - LinkedList.
 *
 * @author Kurt Mammen
 * @version 2/2/2010
 */
...
public class P5TestDriver
{
   ...
   {
      System.out.println("Testing an LinkedList of one element...");  
   ...
   {
      System.out.println("Testing an LinkedList of two elements...");
   ...
   {
      System.out.println("Testing an LinkedList of three elements...");
   ...
   private static boolean testConstructor2()
   {
      ...
      try
      {
         ...
         for(int i = 0; i < list.size(); i++)
         {
            ...
            {
               pass &= test(false, "LinkedList(java.util.List)");
               break;
            }
         }
      }
   ...
   private static boolean testAddForOrderOnePerformance()
   {
      ...
      System.out.println("   If this test does not complete in a few seconds, and you are");
      System.out.println("   running from console, <cntl>-C will terminate your program.");
      boolean pass = true;  
