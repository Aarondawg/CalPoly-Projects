...
public class P4TestDriver
{
   ...
   private static boolean testCircleArch()
   {
      ...
      String[] names = {"equals", "getRadius", "setRadius", "move", "getArea",
   ...
   private static boolean testRectangleArch()
   {
      ...
      String[] names = {"getWidth", "setWidth", "getHeight", "setHeight"};
   ...
   private static boolean testTriangleArch()
   {
      ...
      String[] names = {"getVertexA", "getVertexB", "getVertexC",
   ...
   private static boolean testCircle()
   {
      ...
      pass &= test(circle.getColor().equals(Color.red), test++);
      ...
      pt.x = pt.y = -2;
      pass &= test(circle.getPosition().equals(new Point(-1, -1)), test++);

      // Test move?
      pt.x = -1;
      pt.y = -2;
      circle.move(pt);
      pass &= test(circle.getPosition().equals(new Point(-2, -3)), test++);
     
      // equals...
      circle.setPosition(new Point(-104, 59));
      circle.setColor(Color.cyan);
      circle.setFilled(true);
      
      Circle circle2 = new Circle(4.321, new Point(-104, 59), Color.cyan, true);
      pass &= test(circle.equals(circle2), test++);
      
      circle2 = new Circle(4.321, new Point(-104, 59), Color.cyan, false);
      pass &= test(!circle.equals(circle2), test++);

      circle2 = new Circle(4.321, new Point(-104, 59), Color.red, true);
      pass &= test(!circle.equals(circle2), test++);
 
      circle2 = new Circle(4.321, new Point(104, 59), Color.cyan, true);
      pass &= test(!circle.equals(circle2), test++);

      circle2 = new Circle(4.321, new Point(-104, -59), Color.cyan, true);
      pass &= test(!circle.equals(circle2), test++);

      circle2 = new Circle(4.3211, new Point(-104, 59), Color.cyan, true);
      pass &= test(!circle.equals(circle2), test++);
   ...
   private static boolean testTriangle()
   {
      ...
      //System.out.println("VertexA: " + tri.getVertexA());
      //System.out.println("VertexB: " + tri.getVertexB());
      //System.out.println("VertexC: " + tri.getVertexC());
